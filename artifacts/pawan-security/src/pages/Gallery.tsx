  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative bg-gray-900 py-36 pt-48 overflow-hidden">
        ...
        <img src="/gallery-1.png" alt="Gallery" className="absolute inset-0 w-full h-full object-cover opacity-10" />
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white mb-6 leading-tight">
              Our Work{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-primary">Across Delhi</span>
            </h1>
      ...
      {/* ── Filter ── */}
      <section className="py-10 bg-white border-b border-gray-100 sticky top-16 z-40 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filtered.map((project, i) => {
              ...
              return (
                ...
                >
                  {/* Visual Block */}
                  <div className={`relative h-52 flex items-end p-6 overflow-hidden`}>
                    ...
                    <div className="absolute bottom-4 right-4 bg-white/15 backdrop-blur-sm rounded-lg px-3 py-1.5 z-10">
                  ...
                  <div className="bg-white p-6">
                    <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-primary transition-colors">{project.title}</h3>
      ...
      <section className="py-28 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-gray-600 text-lg">Real feedback from real clients who trust us with their security — homeowners, business owners, and apartment managers.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-red-50 border border-red-100 rounded-2xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="font-bold text-red-900 text-xl">Typical Cheap Installer</h3>
              </div>
